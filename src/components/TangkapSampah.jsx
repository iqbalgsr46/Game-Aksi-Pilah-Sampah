    ...
    >
      ...
      <div className="relative z-40 w-full h-full flex flex-col pointer-events-none">
        ...
        {currentGroupName && (
          <div className="absolute top-6 left-1/2 -translate-x-1/2 z-40 pointer-events-none">
            <div className="bg-white/80 backdrop-blur-sm px-8 py-2 rounded-full border-4 border-emerald-300 shadow-md">
              <span className="text-2xl font-bubbly text-emerald-800 uppercase tracking-widest">{currentGroupName}</span>
            </div>
          </div>
        )}
        ...
        <div key={gameId} className="absolute bottom-0 left-0 w-full flex justify-center items-end gap-12 md:gap-32 pointer-events-auto pb-4">
          ...
          >
            ...
            >
              <img src="/assets/images/Sampah Organik.png" alt="Organik" className="w-32 h-40 md:w-48 md:h-60 object-contain drop-shadow-[0_20px_15px_rgba(0,0,0,0.5)] pointer-events-none" />
              <span className="mt-4 px-4 py-2 bg-black/60 backdrop-blur-sm text-white font-bubbly text-xl md:text-2xl rounded-xl border-2 border-white/30 whitespace-nowrap drop-shadow-md pointer-events-none">Organik</span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <img src="/assets/images/Sampah Non Organik.png" alt="Non Organik" className="w-32 h-40 md:w-48 md:h-60 object-contain drop-shadow-[0_20px_15px_rgba(0,0,0,0.5)] pointer-events-none" />
              <span className="mt-4 px-4 py-2 bg-black/60 backdrop-blur-sm text-white font-bubbly text-xl md:text-2xl rounded-xl border-2 border-white/30 whitespace-nowrap drop-shadow-md pointer-events-none">Non Organik</span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <img src="/assets/images/Sampah B3.png" alt="B3" className="w-32 h-40 md:w-48 md:h-60 object-contain drop-shadow-[0_20px_15px_rgba(0,0,0,0.5)] pointer-events-none" />
              <span className="mt-4 px-4 py-2 bg-black/60 backdrop-blur-sm text-white font-bubbly text-xl md:text-2xl rounded-xl border-2 border-white/30 whitespace-nowrap drop-shadow-md pointer-events-none">B3</span>
            </motion.div>
          </motion.div>
      ...
      {gameOver && (
        <div className="absolute inset-0 z-[100] bg-black/80 backdrop-blur-md flex flex-col items-center justify-center pointer-events-auto">
          ...
          {lives <= 0 && (
            <p className="text-xl md:text-2xl text-red-300 font-bubbly mb-6 text-center px-4">Kamu kelewatan terlalu banyak sampah atau salah tong!</p>
          )}
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <motion.button
              ...
              className="px-8 py-4 bg-gradient-to-b from-emerald-400 to-emerald-600 rounded-2xl border-4 border-white/50 text-white font-bubbly text-2xl md:text-3xl shadow-[0_6px_0_rgba(6,78,59,0.8)]"
            >
              Main Lagi
            </motion.button>
            <motion.button
