      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none">
        ...
        <div className="text-center mb-12 flex flex-col items-center">
          <motion.h1 
            ...
            className="text-5xl md:text-7xl text-yellow-400 tracking-wide drop-shadow-[4px_6px_0_rgba(71,85,105,0.8)]"
            style={{ 
          ...
          <motion.h2 
            ...
            className="text-4xl md:text-6xl text-green-400 tracking-wider -rotate-3 mt-1 drop-shadow-[3px_5px_0_rgba(71,85,105,0.8)]"
            style={{ 
        ...
        <motion.button 
          ...
          whileHover={jellyButtonHover}
          whileTap={jellyButtonTap}
          className="relative pointer-events-auto w-44 h-44 md:w-56 md:h-56 bg-gradient-to-b from-cyan-300/30 to-cyan-500/40 backdrop-blur-md rounded-[3rem] md:rounded-[4rem] border-[8px] border-white/50 flex items-center justify-center shadow-[0_12px_0_rgba(2,132,199,0.3),inset_0_8px_16px_rgba(255,255,255,0.4)] cursor-pointer group overflow-hidden"
          onClick={onStartGame}
        >
          {/* Efek kilap gelembung (Glossy dots) */}
          <div className="absolute top-4 left-6 w-8 h-8 md:w-10 md:h-10 bg-white/70 rounded-full blur-[1px]"></div>
          <div className="absolute top-3 left-16 w-4 h-4 md:w-6 md:h-6 bg-white/70 rounded-full blur-[1px]"></div>
          <div className="absolute bottom-4 right-6 w-6 h-6 md:w-8 md:h-8 bg-white/50 rounded-full blur-[1px]"></div>

          <svg 
            className="w-24 h-24 md:w-28 md:h-28 text-white/90 fill-current transform translate-x-2 group-hover:scale-105 transition-transform duration-200 drop-shadow-md" 
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth="3"
