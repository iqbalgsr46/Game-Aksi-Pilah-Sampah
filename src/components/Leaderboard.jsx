...
export default function Leaderboard({ onClose, playClickSound }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col items-center justify-center px-4 md:px-8 py-12 short:py-4">
        ...
        <motion.div 
          ...
          className="text-center mb-6 md:mb-8 short:mb-2 w-full"
        >
          <h1 className="text-5xl md:text-7xl lg:text-8xl short:text-4xl text-white font-bubbly drop-shadow-[0_10px_10px_rgba(0,0,0,0.6)] tracking-wider" style={{ WebkitTextStroke: '3px #1e3a8a' }}>
            PAPAN PERINGKAT
          </h1>
        </motion.div>
        ...
        {scores.length === 0 ? (
          ...
          <div className="w-full flex flex-col items-center">
            ...
            <div className="w-full h-[60vh] md:h-[65vh] short:h-[70vh] bg-white/10 backdrop-blur-xl border border-white/30 rounded-[2.5rem] p-4 md:p-8 short:p-3 shadow-[0_8px_32px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto pr-2 flex flex-col gap-4 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-white/40 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-white/60 transition-colors">
                {scores.map((entry, index) => (
                  <motion.div 
                    ...
                    className={`flex items-center justify-between py-4 px-4 md:py-5 md:px-6 short:py-2 short:px-3 rounded-2xl border-2 shadow-lg relative group ${
                  ...
                  >
                    ...
                    {/* Ranking & Group Name */}
                    <div className="flex items-center gap-4 md:gap-5 short:gap-3 relative z-10">
                      <div className={`w-12 h-12 md:w-14 md:h-14 short:w-10 short:h-10 rounded-full flex items-center justify-center text-2xl md:text-3xl short:text-xl font-bold border-2 shadow-inner shrink-0 ${
                      ...
                      <h2 className="text-2xl md:text-4xl short:text-xl font-bubbly drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] uppercase tracking-wide truncate max-w-[200px] md:max-w-[16rem]">
                        {entry.groupName}
                      </h2>
                    </div>
                    ...
                    <div className="flex flex-col items-end justify-center relative z-10 shrink-0">
                      <span className="text-4xl md:text-5xl short:text-3xl font-bubbly drop-shadow-[0_4px_4px_rgba(0,0,0,0.6)] leading-none">
                        {entry.score}
                      </span>
                      <span className="text-xs md:text-sm short:text-[10px] font-bold uppercase tracking-widest opacity-90 drop-shadow-md mt-1">
                        Mode: {entry.mode}
                      </span>
                    </div>
                  </motion.div>
      ...
      <div className="absolute bottom-6 right-6 md:bottom-8 md:right-8 short:bottom-3 short:right-3 z-20 flex gap-4 short:gap-2">
        {scores.length > 0 && (
          <motion.button
            ...
            onClick={handleClear}
            title="Reset Data"
            className="relative overflow-hidden w-14 h-14 md:w-16 md:h-16 short:w-10 short:h-10 bg-gradient-to-b from-orange-400/60 to-orange-600/70 backdrop-blur-md rounded-2xl border-[4px] border-white/70 flex items-center justify-center shadow-[0_6px_0_rgba(154,52,18,0.4),inset_0_4px_8px_rgba(255,255,255,0.4)] cursor-pointer group"
          >
            ...
            <svg className="w-7 h-7 md:w-8 md:h-8 short:w-5 short:h-5 text-white/90 drop-shadow-md group-hover:scale-105 transition-transform" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none">
        ...
        <motion.button
          ...
          title="Kembali"
          className="relative overflow-hidden w-14 h-14 md:w-16 md:h-16 short:w-10 short:h-10 bg-gradient-to-b from-red-400/60 to-red-600/70 backdrop-blur-md rounded-2xl border-[4px] border-white/70 flex items-center justify-center shadow-[0_6px_0_rgba(153,27,27,0.4),inset_0_4px_8px_rgba(255,255,255,0.4)] cursor-pointer group"
        >
          <div className="absolute top-1 left-2 w-3 h-3 md:w-4 md:h-4 short:w-2 short:h-2 bg-white/80 rounded-full blur-[0.5px]"></div>
          <div className="absolute top-1 left-6 w-1.5 h-1.5 md:w-2 md:h-2 short:hidden bg-white/80 rounded-full blur-[0.5px]"></div>
          <div className="absolute bottom-2 right-2 w-2.5 h-2.5 md:w-3 md:h-3 short:w-1.5 short:h-1.5 bg-white/60 rounded-full blur-[0.5px]"></div>
          <svg className="w-8 h-8 md:w-9 md:h-9 short:w-6 short:h-6 text-white/90 drop-shadow-md group-hover:scale-105 transition-transform" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round">
